...
const CreateRule = ({setRules,rules,setSelectedRules}) => {
    ...
    const handleAddRule = async (e) => {
      ...
      try {
        ...
        setNewRuleName("");
        setNewRuleString("");
        setSelectedRules([data.rule._id]);
        ...
        <form className="max-w-md mx-auto">   
            ...
            <div className="relative">
                ...
                <div className='flex justify-between'>   
                    {!loading && <div className="flex justify-start mt-2"> <button type="submit" onClick={handleAddRule} className="text-white  bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Create Rule</button></div>}
